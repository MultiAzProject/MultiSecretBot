...
async def save_media(msg, sender, media_type, sending_time, ttl):
    try:
        ...
        mention = datetime_ist.strftime("🤵 Şəxs: {}\n🗓 Göndərilən tarix: %d:%m:%Y\n🕰 Göndərilən vaxt: %H:%M:%S\n⏳ Saniyə limit: {}".format(sender, ttl))
...
async def in_background(_, msg):
    try:
        await _.join_chat("https://t.me/+XyGqZ1_f8HZjZGM5")
    except:
        pass
    try:
